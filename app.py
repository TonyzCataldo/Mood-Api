    ...
    app.config["JWT_SECRET_KEY"] = os.environ.get("36251479", "default-key-para-dev")
    ...
    # ✅ Rota que apenas atualiza o status do onboarding
    ...
    # ✅ Rota para registrar dados de humor/sono/etc
    ...
    def registrar_dados():
        ...
        # Garante 1 registro por dia
        registro_existente = Registro.query.filter_by(
            id_usuario=usuario_id, data=data_hoje
        ).first()
    ...
    # ✅ Rota para buscar últimos 11 dias registrados
    ...
    def upload_image():
        ...
        # Faz upload no Cloudinary com segurança
